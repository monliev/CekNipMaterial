package com.infotechnodev.ceknip.views;
...
public class ShadowLayout extends FrameLayout {
  ...
  private void initAttributes(AttributeSet attrs) {
    TypedArray attr = getContext().obtainStyledAttributes(attrs, com.infotechnodev.ceknip.R.styleable.ShadowLayout, 0, 0);
    if (attr == null) return;

    try {
      cornerRadius = attr.getDimension(com.infotechnodev.ceknip.R.styleable.ShadowLayout_slCornerRadius,
          getResources().getDimension(com.infotechnodev.ceknip.R.dimen.defaultMenuDropShadowCornerRadius));
      shadowSize = attr.getDimension(com.infotechnodev.ceknip.R.styleable.ShadowLayout_slShadowSize,
          getResources().getDimension(com.infotechnodev.ceknip.R.dimen.defaultMenuDropShadowSize));
      dx = attr.getDimension(com.infotechnodev.ceknip.R.styleable.ShadowLayout_slDx, 0);
      dy = attr.getDimension(com.infotechnodev.ceknip.R.styleable.ShadowLayout_slDy, 0);
      shadowColor = attr.getColor(com.infotechnodev.ceknip.R.styleable.ShadowLayout_slShadowColor,
          ContextCompat.getColor(getContext(), com.infotechnodev.ceknip.R.color.finestBlack10));
    } finally {
      attr.recycle();
    }
  }
